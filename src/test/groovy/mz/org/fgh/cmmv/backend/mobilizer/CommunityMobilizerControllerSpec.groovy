...
class CommunityMobilizerControllerSpec extends Specification implements ControllerUnitTest<CommunityMobilizerController>, DomainUnitTest<CommunityMobilizer> {
    ...
    void "Test the save action correctly persists"() {
        ...
        request.json = new CommunityMobilizer(params)
        controller.save()
    ...
    void "Test the update action correctly persists"() {
        ...
        request.method = 'PUT'
        populateValidParams(params)
        def instance = new CommunityMobilizer(params)
        instance.id = 1
        instance.version = 0
