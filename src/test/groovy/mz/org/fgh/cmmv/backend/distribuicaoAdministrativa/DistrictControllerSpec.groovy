...
class DistrictControllerSpec extends Specification implements ControllerUnitTest<DistrictController>, DomainUnitTest<District> {
    ...
    void "Test the save action correctly persists"() {
        ...
        request.json = new District(params)
        controller.save()
    ...
    void "Test the update action correctly persists"() {
        ...
        request.method = 'PUT'
        populateValidParams(params)
        def instance = new District(params)
        instance.id = 1
        instance.version = 0
